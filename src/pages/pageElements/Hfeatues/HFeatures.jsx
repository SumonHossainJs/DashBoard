...
const Notices = () => {
  ...
  const handleSave = async (index, id) => {
    try {
      const updatedData = { title: editTitle, url: editUrl };
      const response = await newRequest.put(`/topNotice/update/${id}`, updatedData);
    ...
    <div className="pl-con">
      ...
      {showcases.length < 4 ? (
        ...
        <div className="warning">
          The maximum number of notices is 4. Edit or delete an existing notice to upload a new one.
        </div>
      )}
